...
H3C Mini router H3C GR-3000AX has a serious buffer overflow vulnerability. By routing/goform/aspForm and properly controlling the param field, a buffer overflow can be caused, resulting in a denial of service attack or even remote code execution. Specifically triggered by EditWlanMacList

# Vulnerability details

Here is the location where the specific function is executed

![image-20250411185739490](4/image-20250411185739490.png)

There is no detection here but direct copying leads to buffer overflow

![image-20250411185757937](4/image-20250411185757937.png)
...
![image-20250411190027114](4/image-20250411190027114.png)