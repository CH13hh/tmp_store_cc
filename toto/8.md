...
A serious buffer overflow vulnerability was found in TOTOLINK A3002RU V2 /A3002R_V2 /A3002R_V4 /A3002RU_V3 and A702R. The vulnerability can be triggered by the route /boafrm/formSysCmd. An attacker can achieve a denial of service attack by sending an HTTP POST request.

# Vulnerability details

Enter here if judgment jump to LABEL_19

![image-20250509213859504](8/image-20250509213859504.png)

There is a buffer overflow here

![image-20250509213941339](8/image-20250509213941339.png)



![image-20250509214008888](8/image-20250509214008888.png)
...
![image-20250509205644778](8/image-20250509205644778.png)

![image-20250509213955866](8/image-20250509213955866.png)