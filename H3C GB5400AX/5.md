...
H3C  router H3C GR-5400AX has a serious buffer overflow vulnerability. By routing/goform/aspForm and properly controlling the param field, a buffer overflow can be caused, resulting in a denial of service attack or even remote code execution. Specifically triggered by Edit_List_SSID
...
![image-20250412235439490](5/image-20250412235439490.png)

There is no detection here but direct copying leads to buffer overflow

![image-20250412235329894](5/image-20250412235329894.png)
...
![image-20250412235544390](5/image-20250412235544390.png)